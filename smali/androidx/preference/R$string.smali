...
.method public static evaluate(FII)I
    ...
    .line 1
    invoke-static {v2}, Landroidx/preference/R$string;->EOCF_sRGB(F)F

    move-result v2

    .line 2
    invoke-static {v3}, Landroidx/preference/R$string;->EOCF_sRGB(F)F

    move-result v3

    .line 3
    invoke-static {p1}, Landroidx/preference/R$string;->EOCF_sRGB(F)F

    move-result p1

    .line 4
    invoke-static {v5}, Landroidx/preference/R$string;->EOCF_sRGB(F)F

    move-result v5

    .line 5
    invoke-static {v6}, Landroidx/preference/R$string;->EOCF_sRGB(F)F

    move-result v6

    .line 6
    invoke-static {p2}, Landroidx/preference/R$string;->EOCF_sRGB(F)F
    ...
    .line 7
    invoke-static {v2}, Landroidx/preference/R$string;->OECF_sRGB(F)F
    ...
    .line 8
    invoke-static {v3}, Landroidx/preference/R$string;->OECF_sRGB(F)F
    ...
    .line 9
    invoke-static {p0}, Landroidx/preference/R$string;->OECF_sRGB(F)F
